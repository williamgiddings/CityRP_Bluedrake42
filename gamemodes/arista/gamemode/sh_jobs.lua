...
TEAM_COBRALEADER = arista.team.add("Cobra Leader", {
	...
	males = "models//player/ct_gsg9.mdl",
	...
	guns = {"arista_baton", "cw_ber_auga1-2", "cw_deagle", "cw_flash_grenade", "cw_smoke_grenade"},
	ammo = {
		pistol = 60,
	},
...
TEAM_COBRA = arista.team.add("Cobra", {
	...
	guns = {"arista_baton", "cw_ber_auga1-2", "cw_g18", "cw_flash_grenade"},
	ammo = {
		pistol = 60,
	},
...
TEAM_POLICECOMMANDER = arista.team.add("Police Commander", {
	...
	guns = {"arista_baton", "cw_mp5", "cw_g18"},
	ammo = {
		pistol = 60,
	},
