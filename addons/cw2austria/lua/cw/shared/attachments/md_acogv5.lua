...
att.aimPos = {"ACOGV5Pos", "ACOGV5Ang"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	...
	function att:drawRenderTarget()
		...
		if not self.freeAimOn then
			ang:RotateAroundAxis(ang:Right(), self.ACOGV5AxisAlign.right)
			ang:RotateAroundAxis(ang:Up(), self.ACOGV5AxisAlign.up)
			ang:RotateAroundAxis(ang:Forward(), self.ACOGV5AxisAlign.forward)
		end
