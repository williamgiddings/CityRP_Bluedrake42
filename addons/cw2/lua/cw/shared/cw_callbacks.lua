...
function CustomizableWeaponry.callbacks:processCategory(category, a1, a2, a3, a4)
	local cat = CustomizableWeaponry.callbacks.categories[category]
	
	local res1, res2, res3, res4 = nil, nil, nil, nil
	
	if cat then
		for callbackName, func in pairs(cat) do
			local r1, r2, r3, r4 = func(self, a1, a2, a3, a4)
