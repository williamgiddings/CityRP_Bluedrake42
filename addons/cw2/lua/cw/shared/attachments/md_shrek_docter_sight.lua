local att = {}
att.name = "md_shrek_docter_sight"
att.displayName = "Docter Sight"
att.displayNameShort = "Docter"
att.aimPos = {"DocterSightPos", "DocterSightAng"}
att.FOVModifier = 15
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT

if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/doctersight")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.DocterSightPos, self.DocterSightAng, 1)
